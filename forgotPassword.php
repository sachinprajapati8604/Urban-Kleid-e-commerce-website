...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($gmail_err) ){
        ...
        if($stmt = mysqli_prepare($conn, $sql)){
            ...
            mysqli_stmt_bind_param($stmt, "s", $param_gmail);
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                // Check if gmail exists, if yes then verify password
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    // Display an error message if gmail doesn't exist
                    $gmail_err = "No account found with that username.";
                }
            } else{
...
?>
    ...
    <div class="container">
    <div class="wrapper mx-auto mx-auto shadow p-3 mb-5 bg-white rounded">
    <header class="Form__Header">
          <h1 class="Form__Title Heading u-h1">Forgot Password</h1>
          <p class="Form__Legend">Please Confirm Your Gmail</p>
        </header>
        ...
        <form class="Login_form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"> 
            <div class="form-group <?php echo (!empty($gmail_err)) ? 'has-error' : ''; ?>">
                ...
                <input placeholder="Enter Gmail" type="gmail" name="gmail" class="form-control" value="<?php echo $gmail; ?>">
                <span class="help-block"><?php echo $gmail_err; ?></span>
            </div>
            
            <div class="form-group  ">
                <input type="submit" class="btn  Button-Login" value="Submit">
                <p class="Form_hint">Go back to home <a href="welcome.php">Cancel</a>.</p>
            </div>
