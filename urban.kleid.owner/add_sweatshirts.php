  ...
  if (count($_FILES) > 0) {
    ...
    if (is_uploaded_file($_FILES['userImage']['tmp_name']) || ($_FILES['userImage2']['tmp_name']) || ($_FILES['userImage3']['tmp_name']) || ($_FILES['userImage4']['tmp_name'])) {
     ...
     $folder3 = "../img/" . $filename4;
      ...
      $sql = "INSERT INTO `sweatshirts`(`pro_name`, `pro_shortdetail`, `pro_price`, `pro_bid_price`, `pro_imagename`, `imageType`, `vp_img2`, `vp_img3`, `vp_img4`, `created`) VALUES ('$p_title','$p_detail','$p_price','$p_bidprice','{$filename}','{$imageProperties['mime']}','{$filename2}','{$filename3}','{$filename4}',current_timestamp())";
...
<div class="container shadow-sm border my-4" style="max-width: 800px;">
  <h2 class="text-center">SWEATSHIRTS</h2>
    <form action="" method="post" enctype="multipart/form-data">
      <p class="mb-3 font-weight-normal text-center">Upload your Sweatshirts here</p>
      <hr>
