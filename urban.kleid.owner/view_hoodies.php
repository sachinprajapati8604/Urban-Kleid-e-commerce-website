...
<?php include 'basic/navbar.php'; ?>
    ...
    <div class="alert alert-info" role="alert">
       click to 
        <a href="add_hoodies.php" class="btn btn-success"> Add More Hoodies</a>
    </div>
...
<!-- ----adding row for product display---------------- -->
  ...
  $sql = "SELECT * FROM `hoodies` ORDER BY pro_id DESC";
  ...
  while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo ' 
           <div class="col-md-3 my-2 card-deck">
                  ...
                  <a href="update_hoodies.php?proid='.$id.'" type="button" class="btn btn-outline-success ">Update</a>
                  <a href="delete_hoodies.php?proid='.$id.'" type="button" class="btn btn-outline-danger ">Delete</a>
