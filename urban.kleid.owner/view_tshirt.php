...
<?php include 'basic/navbar.php'; ?>
    ...
    <div class="alert alert-info" role="alert">
       click to 
        <a href="add_tshirt.php" class="btn btn-success"> Add More T-shirts</a>
    </div>
  ...
  while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo ' 
           <div class="col-md-3 my-2 card-deck">
                  ...
                  <a href="update_tshirt.php?proid='.$id.'" type="button" class="btn btn-outline-success ">Update</a>
                  <a href="delete_tshirt.php?proid='.$id.'" type="button" class="btn btn-outline-danger ">Delete</a>
